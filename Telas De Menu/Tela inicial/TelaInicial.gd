...
func _trocar_de_tela():
	...
	var error = get_tree().change_scene_to_file("res://Jogo/main.tscn")
	if error != OK:
		print("ERRO: Não foi possível carregar a cena. Verifique se o caminho 'res://Jogo/main.tscn' está correto.")
